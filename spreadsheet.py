...
creds = ServiceAccountCredentials.from_json_keyfile_name("D:/projects/face_recoginition/Face-recognition-based-attendance-system-master/face recognition source code/credentials.json", scope)
